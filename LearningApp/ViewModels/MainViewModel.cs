...
public class MainViewModel : ViewModelBase
{
	public MainViewModel()
	{
		...
		_listBoxText = new ObservableCollection<string> { "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1" };
	...
	{
		ListBoxText = new ObservableCollection<string> { "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1", "Test1" };
	}
	...
	private void ChangeListBoxTextBackground()
	{
		while (true)
		{
			...
			_listBoxText[itemPosition] = _listBoxText[itemPosition].Substring(0, 4) + " " + random.Next(1000).ToString("000");
			...
			{
				ListBoxBackgroundColor = match ? new SolidColorBrush(Color.FromRgb(0, 255, 0), 0.2) : new SolidColorBrush(Color.FromRgb(255, 0, 0), 0.2);
			}));
		}
	}
	...
	{
		ObservableCollection<SimpleModel> simpleModels = new ObservableCollection<SimpleModel>();
